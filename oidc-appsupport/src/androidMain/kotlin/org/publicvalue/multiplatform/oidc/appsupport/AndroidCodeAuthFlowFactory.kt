...
public class AndroidCodeAuthFlowFactory(
    /**
     ...
     * Check [Browser][org.publicvalue.multiplatform.oidc.appsupport.customtab.Browser]
     * for example values.
     **/
                ...
                override fun onStateChanged(source: LifecycleOwner, event: Lifecycle.Event) {
                    when (event) {
                        Lifecycle.Event.ON_CREATE -> {
                            activityResultLauncher = activity.registerForActivityResultSuspend(
                                resultFlow, ActivityResultContracts.StartActivityForResult()
                            )
                        }
    ...
    override fun createAuthFlow(client: OpenIdConnectClient): PlatformCodeAuthFlow {
        ...
        val preferredBrowserPackage = if (customTabProviderPriority.isNotEmpty()) {
            ...
            customTabProviders.firstOrNull()
        }
