...
include(":core")
include(":sample-app:common:ui:compose")
include(":sample-app:common:ui:resources:strings")
include(":sample-app:common:screens")
include(":sample-app:data:settings")
include(":sample-app:core")
include(":sample-app:webserver")
include(":sample-app:shared")
include(":sample-app:domain")
include(":sample-app:ui:common")
include(":sample-app:ui:root")
include(":sample-app:ui:idplist")
include(":sample-app:ui:clientlist")
include(":sample-app:ui:clientdetail")
include(":sample-app:desktop-app")
include(":sample-app:data:db-sqldelight")
